...
collections = [
    {
        ...
        "description": "Коллекция уникальных фигурок с ограниченным тиражом. Каждая фигурка — результат недель кропотливой работы.",
        "badge": "NEW"
    },
    {
        "id": "IND_Collection",
    ...
    },
    {
        ...
        "description": "Закажите брелки с индивидуальным дизайном",
        "badge": None
    },
    {
        "id": "seasonal",
